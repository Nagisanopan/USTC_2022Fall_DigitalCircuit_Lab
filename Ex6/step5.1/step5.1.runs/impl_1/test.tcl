...
namespace eval ::optrace {
  variable script "E:/USTC/2nd year-1st sem/Digital circuit Experiment/Ex6/step5.1/step5.1.runs/impl_1/test.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet {{E:/USTC/2nd year-1st sem/Digital circuit Experiment/Ex6/step5.1/step5.1.runs/synth_1/test.dcp}}
